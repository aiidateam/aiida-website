...
- **`core.ssh_async`:** **Only 4 seconds!** 🚀🚀🚀🚀 _A dramatic improvement!_
...
> _Example: On a network with a baseline of 11.8 MB/s, the asynchronous mode approached nearly twice that speed under light load (see graph in PR [#6626](https://github.com/aiidateam/aiida-core/pull/6626))._
