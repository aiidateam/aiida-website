---
title: "Live monitoring of running simulations with AiiDA"
date: 2026-01-23
category: Blog
...
Interestingly, this feature was initially motivated not by simulations, but by a study where AiiDA was used to orchestrate real-world experiments on batteries: [P. Kraus _et al._, A bridge between trust and control: computational workflows meet automated battery cycling, J. Mater. Chem. A, 12, 10773 (2024)](https://doi.org/10.1039/D3TA06889G).
...
(Note that as we `submit` the job in the script, the AiiDA daemon must be running.)
...
![Plot of the content of temperature.log showing that the temperature is kept within the expected range](/aiida-website/blog-img/_pics/temperature-plot.png)
...
Do you have other ideas for how monitors could help in your simulations?
