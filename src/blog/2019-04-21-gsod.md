---
title: "AiiDA project & Google Season of Docs"
date: 2019-04-21
category: News
tags: [gsod]
---

```{image} /blog-img/legacy/google_season_of_docs.png
:alt: Google season of docs
:width: 50%
```

The AiiDA project is happy to announce its application to participate in this year's [Google Season of Docs (GSoD)](https://developers.google.com/season-of-docs/). GSoD tries to bring open source projects and technical writers together: To give technical writers experience in contributing to open source projects and help opens source projects to improve their documentation and interact with the technical writing community.

## What happens next

See also the [full timeline](https://web.archive.org/web/20250401004121/https://developers.google.com/season-of-docs/docs/timeline):

- **April 30, 2019** Google publishes the list of accepted mentoring organizations

- **May 29, 2019** Start of technical writer application period. More details about the application process can be found in the [technical writer guide](https://web.archive.org/web/20250129105457/https://developers.google.com/season-of-docs/docs/tech-writer-guide), where also the application form will be published
...
```{figure} /blog-img/legacy/aiida-workflow.png
